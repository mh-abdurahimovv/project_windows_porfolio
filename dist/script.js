...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('preview')) {
      imgPopup.style.display = 'flex'; // imgPopup.style.width = '300px'
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var closeClockOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeSelector) {
...
var timer = function timer(id, deadline) {
  function getTiimeRemaining(endTime) {
    var tech = Date.parse(endTime) - Date.parse(new Date()),
  ...
  function setClock(selector, endTime) {
    ...
    function updateClock() {
      var timeLeft = getTiimeRemaining(endTime);
